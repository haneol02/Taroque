...
const CARD_W = 72;
const CARD_H = 120;
const FAN_X_SPAN = 1020; // 전체 가로 폭 (좌우 각 510px)
const FAN_SAG = 48;      // 중앙 카드가 얼마나 위로 올라가는지
const FAN_CONTAINER_H = 260; // 팬 컨테이너 높이 (hover 공간 포함)
    ...
    <div className="w-full flex flex-col items-center gap-6">
            ...
            <div key={i} className="flex flex-col items-center gap-1.5">
              ...
              <div
                ...
                className={`relative rounded-xl transition-all duration-300 ${
                  actualCard ? 'shadow-lg' : 'slot-empty'
                }`}
              >
                {actualCard ? (
                  <div
                  ...
                  <div className="w-full h-full flex items-center justify-center rounded-xl"
                    ...
                    <span
                      ...
                      style={{ color: 'rgba(196,181,253,0.35)', fontFamily: 'Georgia, serif' }}
                    >
                      {i + 1}
                    </span>
                  </div>
      ...
      >
        <div
          ...
          style={{ minWidth: `${FAN_X_SPAN + CARD_W + 80}px` }}
        >
          {/* 중앙 원형 글로우 장식 */}
          <div
            className="absolute"
      ...
      {selections.length === requiredCount && (
        <div ref={proceedRef} className="mt-2">
          <button
            ...
            className="inline-flex items-center gap-3 text-white font-medium py-3 px-10 rounded-full transition-all duration-300 transform hover:scale-105 active:scale-95 disabled:opacity-60"
            style={{
              background: 'linear-gradient(135deg, rgba(139,92,246,0.35) 0%, rgba(109,40,217,0.35) 100%)',
    ...
    >
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
        <svg viewBox="0 0 42 52" className="w-8 h-10 opacity-85" fill="none">
          <path
            d="M23 9 C15 9 8 15.5 8 24 C8 32.5 15 39 23 39 C17 37 13 31 13 24 C13 17 17 11.5 23 9Z"
          ...
          <path
            d="M31 7.5 L31.6 9.2 L33.4 9.2 L31.9 10.2 L32.5 12 L31 10.9 L29.5 12 L30.1 10.2 L28.6 9.2 L30.4 9.2 Z"
